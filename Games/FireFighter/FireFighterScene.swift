...
class FireFighterScene: SKScene {
    let player = SKSpriteNode(imageNamed: "Character-Front-0")
    var fire = SKSpriteNode(imageNamed: "Explosion-0")
    ...
    override func sceneDidLoad() {
        ...
        Timer.scheduledTimer(withTimeInterval: 3, repeats: true) { [weak self] _ in
            ...
            let enemy = SKSpriteNode(imageNamed: "Character-Right-1")
    ...
    func createFire() {
        fire = SKSpriteNode(imageNamed: "Explosion-0")
...
extension FireFighterScene: SKPhysicsContactDelegate {
